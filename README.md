...
5. أعد النشر. رابط التسجيل هو جذر الموقع، ولوحة الإدارة على `/admin`.
...
- ملف التحقق الخاص بـ loader.io متاح على
  `/loaderio-eb224dd43637f14ed280c60ce0337281.txt` بعد النشر.
